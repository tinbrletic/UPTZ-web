    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto">
        <nav className="mb-8 text-sm">
          ...
          &gt;{" "}
          <span className="text-gray-600">{t("projects.projectList.wilson")}</span>
        </nav>

        <h1 className="text-4xl font-bold mb-6">{t("projects.projectList.wilson")}</h1>
        ...
        <section className="mb-10">
          ...
          <p className="text-lg mb-4">{t("projects.detail.wilson.overview")}</p>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("projects.features")}</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>{t("projects.detail.wilson.features.feature1")}</li>
            <li>{t("projects.detail.wilson.features.feature2")}</li>
            <li>{t("projects.detail.wilson.features.feature3")}</li>
          </ul>
        </section>

        <section className="mb-10">
          <h2 className="text-2xl font-bold mb-4">{t("projects.technical")}</h2>
          <p className="text-lg mb-4">{t("projects.detail.wilson.technical")}</p>
        </section>
